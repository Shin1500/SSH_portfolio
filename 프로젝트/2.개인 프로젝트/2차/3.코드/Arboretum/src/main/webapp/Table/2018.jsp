...
<%
    ...
    try {
        ...
        String sql = "SELECT SUM(Count) AS total_count FROM tourist WHERE Year = '2018년'";
        pstmt = conn.prepareStatement(sql);
        rs = pstmt.executeQuery();

        if (rs.next()) {
            total_2018 = rs.getInt("total_count");
        }
    } catch (Exception e) {
        e.printStackTrace();
    }
%>
<h2>2018년 총 관람객 수: <%= total_2018 %>명</h2>
...
<div id="chart-container" style="display: none; vertical-align: top;">
    <!-- 차트를 포함한 2018.jsp 파일을 불러와서 표시 -->
    <iframe src="../Chart/2018.jsp" width="500" height="500" frameborder="0"></iframe>
</div>
<!-- 홈으로 버튼 -->
<div id="home-btn">
